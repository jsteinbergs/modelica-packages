within ;
model TwoRoomsWithStorageAndHeatPump
  "Model of a hydronic heating system with energy storage and a heat pump"
 ...
 parameter Real scaFacRad = 1.5
  ...
  parameter
    Buildings.HeatTransfer.Data.OpaqueConstructions.Insulation100Concrete200 matLayExt
  ...
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic matLayFlo(material=
        {Buildings.HeatTransfer.Data.Solids.Concrete(x=0.2),
        Buildings.HeatTransfer.Data.Solids.InsulationBoard(x=0.15),
        Buildings.HeatTransfer.Data.Solids.Concrete(x=0.05)}, final nLay=3)
  ...
  Buildings.ThermalZones.Detailed.MixedAir roo2(
    redeclare package Medium = MediumA,
    AFlo=6*4,
    hRoo=2.7,
    nConExt=0,
  ...
  Buildings.Controls.OBC.CDL.Reals.PID conRoo2(
    yMax=1,
    yMin=0,
    Ti=60,
    Td=60,
  ...
  Buildings.Controls.OBC.CDL.Reals.PID conRoo1(
    yMax=1,
    yMin=0,
    Ti=60,
    Td=60,
  ...
  Buildings.Controls.SetPoints.OccupancySchedule occSch1(occupancy=3600*{7,8,10,
        11,11.5,15,19,21}) "Occupancy schedule"
  ...
  Buildings.Controls.SetPoints.OccupancySchedule occSch2(firstEntryOccupied=
        false, occupancy=3600*{7,10,12,22}) "Occupancy schedule"
  ...
  Buildings.Controls.OBC.CDL.Reals.MultiMax mulMax(nin=2)
    "Maximum radiator valve position"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  Buildings.Controls.OBC.CDL.Reals.Hysteresis hysPum(uLow=0.01, uHigh=0.5)
    "Hysteresis for pump"
  ...
  Buildings.HeatTransfer.Conduction.MultiLayer parWal(
    ...
    stateAtSurface_b=true) "Partition wall between the two rooms" annotation (
  ...
  Buildings.Airflow.Multizone.Orifice lea1(redeclare package Medium = MediumA,
      A=0.01^2) "Leakage of facade of room"
    annotation (Placement(transformation(extent={{320,430},{340,450}})));
  Buildings.Airflow.Multizone.Orifice lea2(redeclare package Medium = MediumA,
      A=0.01^2) "Leakage of facade of room"
...
Changed controller to output setpoint for supply air temperature for cooling coil.
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant occ1(k=1/6/4)
  ...
  Buildings.Controls.OBC.CDL.Reals.MovingAverage aveTOut(delta=24*3600)
...
end TwoRoomsWithStorageAndHeatPump;
