...
model LumpedCommunity
  ...
  CommunityLoads loads(
    nu=2,
    P_nominal=-2000,
    pf=0.8) annotation (Placement(transformation(extent={{-20,-20},{0,0}})));
  ...
  Modelica.Blocks.Sources.TimeTable loadProfile1(
    table=[0,0.05; 9,0.05; 9,0.2; 11,0.2; 11,0.1; 15,0.1; 15,0.3; 18,0.3; 18,1;
        20,1; 20,0.6; 22,0.6; 24,0.6; 24,0.05; 30,0.05; 30,0.3; 32,0.3; 32,0.05;
        42,0.05; 42,0.4; 43,0.4; 43,0.8; 44,0.8; 44,0.6; 46,0.6; 46,0.2; 48,0.2;
        48,0.05; 54,0.05; 54,0.2; 56,0.2; 56,0.1; 66,0.1; 66,0.7; 69,0.7; 69,
...
equation
  ...
  connect(loadProfile.y, loads.u) annotation (Line(points={{-59,50},{-30,50},{
          -30,-10},{-20,-10}}, color={0,0,127}));
  ...
  connect(loadProfile1.y, loads.u[2]) annotation (Line(points={{-59,10},{-30,10},
          {-30,-8.5},{-20,-8.5}}, color={0,0,127}));
