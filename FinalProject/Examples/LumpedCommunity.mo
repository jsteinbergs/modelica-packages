...
equation
  ...
  connect(control.P, community.batP) annotation (Line(points={{19,-30},{-6,-30},
          {-6,-16},{-1,-16}}, color={0,0,127}));
  connect(loadProfile.y, community.loa) annotation (Line(points={{-59,10},{-40,
          10},{-40,-4},{-1,-4}}, color={0,0,127}));
